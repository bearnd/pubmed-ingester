...
def upgrade():
    ...
    sa.Column('num_registry', sa.Unicode(length=9), nullable=True),
    sa.Column('uid', sa.Unicode(length=7), nullable=True),
    sa.Column('chemical', sa.Unicode(), nullable=True),
    ...
    sa.Column('databank_id', sa.SmallInteger(), nullable=False),
    sa.Column('name', sa.Unicode(length=20), nullable=False),
    sa.PrimaryKeyConstraint('databank_id')
    )
    op.create_index(op.f('ix_databanks_name'), 'databanks', ['name'], unique=True)
    ...
    sa.Column('journal_info_id', sa.Integer(), nullable=False),
    sa.Column('nlmid', sa.Unicode(length=9), nullable=True),
    ...
    sa.Column('issn', sa.Unicode(length=9), nullable=False),
    ...
    sa.Column('publication_type_id', sa.SmallInteger(), nullable=False),
    sa.Column('uid', sa.Unicode(length=7), nullable=True),
    sa.Column('name', sa.Unicode(length=9), nullable=True),
    ...
    sa.Column('pub_year', sa.SmallInteger(), nullable=False),
    sa.Column('pub_month', sa.SmallInteger(), nullable=True),
    sa.Column('pub_day', sa.SmallInteger(), nullable=True),
    sa.Column('dt_published', sa.Date(), nullable=True),
    sa.Column('pub_model', sa.Enum('print', 'print_electronic', 'electronic', 'electronic_print', 'electronic_ecollection', name='articlepubmodel'), nullable=True),
    ...
    op.create_index(op.f('ix_articles_pub_year'), 'articles', ['pub_year'], unique=False)
    ...
    sa.Column('abstract_text_id', sa.BigInteger(), nullable=True),
    ...
    sa.Column('article_id', sa.BigInteger(), nullable=True),
    sa.Column('databank_id', sa.SmallInteger(), nullable=True),
    sa.Column('accession_number_id', sa.BigInteger(), nullable=True),
    ...
    sa.Column('article_id', sa.BigInteger(), nullable=True),
    sa.Column('grant_id', sa.BigInteger(), nullable=True),
    sa.ForeignKeyConstraint(['article_id'], ['articles.article_id'], ),
    ...
    sa.Column('article_id', sa.BigInteger(), nullable=True),
    sa.Column('publication_type_id', sa.SmallInteger(), nullable=True),
    sa.ForeignKeyConstraint(['article_id'], ['articles.article_id'], ),
    ...
    sa.Column('article_id', sa.BigInteger(), nullable=True),
    sa.Column('journal_info_id', sa.Integer(), nullable=True),
    ...
    sa.Column('chemical_id', sa.BigInteger(), nullable=True),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_articles_pub_year'), table_name='articles')
    ...
    op.drop_index(op.f('ix_databanks_name'), table_name='databanks')
